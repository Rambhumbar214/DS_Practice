/*Write a C program to read the data from the file “person.txt” which contains person no and
person age and sort the data on age in ascending order using insertion Sort.
*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
